...
export default function Home() {
  return (
    <div className="bg-slate-100 h-full">
      <title>Blog Website (AI)</title>
      <h1 className="text-center text-black text-5xl pt-6 font-serif">Blog Website (AI)</h1>
      <div className="flex justify-center items-center h-screen">
        <Image src={abc} alt="No" className="xl:h-[600px] xl:w-full lg:h-[550px] lg:w-full md:h-[400px] md:w-[1100px] sm:h-[350px] sm:w-full mt-[-50]" />
      </div>
